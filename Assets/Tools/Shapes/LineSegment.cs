...
namespace Shapes
{
    public static class LineSegment
    {
        ...
        static Material GetArrowHeadMaterial()
        {
            ...
            {
                _arrowHeadMaterial = new Material(
                    Shader.Find("Hidden/Shapes/LineSegment/ArrowHead")
                );
            }
        ...
        private static Mesh CreateLineSegmentMesh()
        {
            ...
            quadMesh.triangles = new[] { 0, 1, 4, 4, 3, 0, 1, 2, 5, 5, 4, 1, };
        ...
        static Matrix4x4 GetLineTRSMatrix(
            Vector3 startPos,
            Vector3 endPos,
            Vector3 forward,
            float width,
